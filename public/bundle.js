...
(function($PS) {
  ...
  var render = function (state) {
      ...
      throw new Error("Failed pattern match at Component.Node (line 58, column 3 - line 82, column 10): " + [ state.ast.expr.constructor.name ]);
  };
...
(function($PS) {
  ...
  var lambda = function (e) {
      return node(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(lexer.lexeme(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)("\\")))(function (v) {
...
(function($PS) {
  ...
  var handleInitialize = (function () {
      var parsed = Parse.parse("((\\x.\\y.\\s.\\z.((x s) ((y s) z)) \\s.\\z.(s z)) \\s.\\z.(s (s z)))");
      if (parsed instanceof Data_Either.Left) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
      };
      if (parsed instanceof Data_Either.Right) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Core.replaceIds(parsed.value0)))(function (v) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  return {
                      lines: Data_Array.cons(v)(s.lines)
                  };
              });
          });
      };
      throw new Error("Failed pattern match at Component.Stepper (line 112, column 5 - line 117, column 52): " + [ parsed.constructor.name ]);
  })();
  var handleApplied = function (id) {
      ...
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(lastLine))(function (v) {
              ...
              if (v1.value0 instanceof Data_Maybe.Just && v1.value1 instanceof Data_Maybe.Just) {
                  ...
                  if (v2 instanceof Data_Either.Right) {
                      ...
                      if (v3 instanceof Data_Either.Right) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                              return {
                                  lines: Data_Array.cons(v3.value0)(s.lines)
                              };
                          });
                      };
                      throw new Error("Failed pattern match at Component.Stepper (line 82, column 15 - line 86, column 66): " + [ v3.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Component.Stepper (line 78, column 11 - line 86, column 66): " + [ v2.constructor.name ]);
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          if (v instanceof Data_Maybe.Nothing) {
          ...
          throw new Error("Failed pattern match at Component.Stepper (line 71, column 3 - line 90, column 16): " + [ v.constructor.name ]);
      });
  };
  var handleAction = function (action) {
      ...
      throw new Error("Failed pattern match at Component.Stepper (line 62, column 23 - line 66, column 21): " + [ action.constructor.name ]);
  };
...
(function($PS) {
  ...
  var removeChildren = function (node) {
      return function __do() {
          ...
          var v1 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Function.flip(Web_DOM_Node.removeChild)(node))(v)();
          return Data_Unit.unit;
      };
  };
  var main = (function () {
      var toHTMLElements = (function () {
          var toHTMLElementArray = function (els) {
              return function (v) {
                  if (v instanceof Data_Maybe.Just) {
                      return Data_Array.cons(v.value0)(els);
                  };
                  if (v instanceof Data_Maybe.Nothing) {
                      return els;
                  };
                  throw new Error("Failed pattern match at Main (line 38, column 9 - line 38, column 90): " + [ els.constructor.name, v.constructor.name ]);
              };
          };
          var $17 = Control_Applicative.pure(Effect.applicativeEffect);
          var $18 = Data_Foldable.foldl(Data_Foldable.foldableArray)(toHTMLElementArray)(Data_Monoid.mempty(Data_Monoid.monoidArray));
          var $19 = Data_Functor.map(Data_Functor.functorArray)(Web_HTML_HTMLElement.fromNode);
          return function ($20) {
              return $17($18($19($20)));
          };
      })();
      var initStepper = function (element) {
          return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
              return Halogen_VDom_Driver.runUI(Component_Stepper.component)(Data_Unit.unit)(element);
          }));
      };
      return function __do() {
          ...
          var v1 = Control_Bind.bind(Effect.bindEffect)(Web_DOM_ParentNode.querySelectorAll(".explorable")(v))(Web_DOM_NodeList.toArray)();
          var v2 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(removeChildren)(v1)();
          var v3 = toHTMLElements(v1)();
          var v4 = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(initStepper)(v3)();
          return Data_Unit.unit;
      };
  })();
  exports["main"] = main;

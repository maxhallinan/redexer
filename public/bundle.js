...
(function($PS) {
      ...
      return function ($$new) {
          return function (old) {
              ...
              if (old.expr instanceof Apply) {
                  ...
                  throw new Error("Failed pattern match at Core (line 78, column 9 - line 83, column 38): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Core (line 62, column 3 - line 83, column 38): " + [ old.expr.constructor.name ]);
          };
      };
  };
  var replaceIds = function (tree) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Core (line 134, column 3 - line 143, column 46): " + [ tree.expr.constructor.name ]);
      };
  };
  var findNode = function (id) {
      return function (tree) {
          ...
          throw new Error("Failed pattern match at Core (line 87, column 3 - line 99, column 56): " + [ tree.expr.constructor.name ]);
      };
  }; 
          ...
          var subParam = function (paramName) {
              return function (body) {
                  if (body.expr instanceof Var) {
                      var $88 = paramName === body.expr.value0;
                      if ($88) {
                          return arg;
                      };
                      return body;
                  ...
                  throw new Error("Failed pattern match at Core (line 117, column 7 - line 129, column 12): " + [ body.expr.constructor.name ]);
              };
          };

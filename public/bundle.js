...
(function($PS) {
  ...
  var replaceIds = function (tree) {
      return function __do() {
          ...
          throw new Error("Failed pattern match at Core (line 133, column 3 - line 142, column 46): " + [ tree.expr.constructor.name ]);
      };
  };
  exports["Var"] = Var;
...
(function($PS) {
  ...
  var render = function (state) {
      ...
      if (state.ast.expr instanceof Core.Lambda) {
          return Halogen_HTML_Elements.span([  ])([ Halogen_HTML_Core.text("\\" + (state.ast.expr.value0 + ".")), render({
              ast: state.ast.expr.value1
          }) ]);
      };
      if (state.ast.expr instanceof Core.Apply) {
          return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("apply") ])([ Halogen_HTML_Core.text("("), render({
              ast: state.ast.expr.value0
          }), Halogen_HTML_Core.text(" "), render({
              ast: state.ast.expr.value1
          }), Halogen_HTML_Core.text(")") ]);
      };
      throw new Error("Failed pattern match at Component.Node (line 39, column 3 - line 56, column 10): " + [ state.ast.expr.constructor.name ]);
  };
...
(function($PS) {
  ...
  var handleInitialize = (function () {
      var parsed = Parse.parse("((\\x.\\y.x z) a)");
      ...
      if (parsed instanceof Data_Either.Right) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Core.replaceIds(parsed.value0)))(function (v) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  return {
                      lines: Data_Array.snoc(s.lines)(v)
                  };
              });
          });
      };
      throw new Error("Failed pattern match at Component.Stepper (line 66, column 5 - line 71, column 55): " + [ parsed.constructor.name ]);
  })();
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("stepper") ])(Data_Array.mapWithIndex(renderLine)(state.lines));
  };
  var component = Halogen_Component.mkComponent({

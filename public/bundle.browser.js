...
(function($PS) {
  ...
  var Effect = $PS["Effect"];                
  var NodeNotFound = (function () {
      function NodeNotFound(value0) {
          this.value0 = value0;
      };
      NodeNotFound.create = function (value0) {
          return new NodeNotFound(value0);
      };
      return NodeNotFound;
  })();
  var Var = (function () {
  ...
  var NotALambda = (function () {
      function NotALambda() {

      };
      NotALambda.value = new NotALambda();
      return NotALambda;
  })();
  var replaceNode = function (id) {
      return function ($$new) {
          return function (old) {
              var replace = replaceNode(id)($$new);
              if (old.expr instanceof Var) {
                  var $29 = old.id === id;
                  if ($29) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)($$new);
                  };
                  return new Data_Either.Left(new NodeNotFound(id));
              };
              if (old.expr instanceof Lambda) {
                  var $31 = old.id === id;
                  if ($31) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)($$new);
                  };
                  return Control_Bind.bind(Data_Either.bindEither)(replace(old.expr.value1))(function (v) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)({
                          id: old.id,
                          expr: new Lambda(old.expr.value0, v)
                      });
                  });
              };
              if (old.expr instanceof Apply) {
                  var $35 = old.id === id;
                  if ($35) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)($$new);
                  };
                  var toApplyNode = function (x) {
                      return function (y) {
                          return {
                              id: old.id,
                              expr: new Apply(x, y)
                  ...
                  var v = replace(old.expr.value0);
                  if (v instanceof Data_Either.Left) {
                      return Control_Bind.bind(Data_Either.bindEither)(replace(old.expr.value1))(function (v1) {
                          return Control_Applicative.pure(Data_Either.applicativeEither)(toApplyNode(old.expr.value0)(v1));
                      });
                  };
                  if (v instanceof Data_Either.Right) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(toApplyNode(v.value0)(old.expr.value1));
                  };
                  throw new Error("Failed pattern match at Core (line 83, column 9 - line 88, column 38): " + [ v.constructor.name ]);
              };
              throw new Error("Failed pattern match at Core (line 67, column 3 - line 88, column 38): " + [ old.expr.constructor.name ]);
          };
      };
  };
  var replaceIds = function (tree) {
      return function __do() {
          var v = Data_Functor.map(Effect.functorEffect)(Data_UUID.toString)(Data_UUID.genUUID)();
          if (tree.expr instanceof Var) {
              return {
                  id: v,
                  expr: tree.expr
              };
          };
          if (tree.expr instanceof Lambda) {
              var v1 = replaceIds(tree.expr.value1)();
              return {
                  id: v,
                  expr: new Lambda(tree.expr.value0, v1)
              };
          };
          if (tree.expr instanceof Apply) {
              var v1 = replaceIds(tree.expr.value0)();
              var v2 = replaceIds(tree.expr.value1)();
              return {
                  id: v,
                  expr: new Apply(v1, v2)
              };
          };
          throw new Error("Failed pattern match at Core (line 139, column 3 - line 148, column 46): " + [ tree.expr.constructor.name ]);
      };
  }; 
  var findNode = function (id) {
      return function (tree) {
          if (tree.expr instanceof Var) {
              var $76 = tree.id === id;
              if ($76) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(tree);
              };
          ...
          if (tree.expr instanceof Lambda) {
              ...
              return findNode(id)(tree.expr.value1);
          };
          if (tree.expr instanceof Apply) {
              var $81 = tree.id === id;
              if ($81) {
              ...
              return Data_Maybe.maybe(findNode(id)(tree.expr.value1))(Control_Applicative.pure(Data_Maybe.applicativeMaybe))(findNode(id)(tree.expr.value0));
          };
          throw new Error("Failed pattern match at Core (line 92, column 3 - line 104, column 56): " + [ tree.expr.constructor.name ]);
      };
  }; 
  var applyLambda = function (fn) {
      return function (arg) {
          var subParam = function (paramName) {
              return function (body) {
                  if (body.expr instanceof Var) {
                      var $103 = paramName === body.expr.value0;
                      if ($103) {
                          return arg;
                      };
                      return body;
                  };
                  if (body.expr instanceof Lambda) {
                      return {
                          id: body.id,
                          expr: new Lambda(body.expr.value0, subParam(paramName)(body.expr.value1))
                      };
                  };
                  if (body.expr instanceof Apply) {
                      return {
                          id: body.id,
                          expr: new Apply(subParam(paramName)(body.expr.value0), subParam(paramName)(body.expr.value1))
                      };
                  };
                  throw new Error("Failed pattern match at Core (line 122, column 7 - line 134, column 12): " + [ body.expr.constructor.name ]);
              };
          };
          if (fn.expr instanceof Lambda) {
              return Data_Either.Right.create(subParam(fn.expr.value0)(fn.expr.value1));
          };
          return new Data_Either.Left(NotALambda.value);
      };
  };
  exports["Var"] = Var;
...
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["Component.Node"] = $PS["Component.Node"] || {};
  var exports = $PS["Component.Node"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Category = $PS["Control.Category"];
  var Core = $PS["Core"];
  var Data_Maybe = $PS["Data.Maybe"];
  ...
  var Applied = (function () {
      function Applied(value0) {
          this.value0 = value0;
      };
      Applied.create = function (value0) {
          return new Applied(value0);
      };
      return Applied;
  })();
  ...
  var isApplicable = function (v) {
      if (v.expr instanceof Core.Lambda) {
          return true;
      };
      return false;
  };
  var initState = Control_Category.identity(Control_Category.categoryFn);
  var handleApplyClick = function (id) {
      return function (e1) {
          return function (mouseEvent) {
              if (e1.expr instanceof Core.Lambda) {
                  return Data_Maybe.Just.create(new ApplyClicked(id, mouseEvent));
              };
              return Data_Maybe.Nothing.value;
          };
      };
  ...
  var render = function (state) {
      if (state.ast.expr instanceof Core.Var) {
          return Halogen_HTML_Core.text(state.ast.expr.value0);
      };
      if (state.ast.expr instanceof Core.Lambda) {
          return Halogen_HTML_Elements.span([  ])([ Halogen_HTML_Core.text("\u03bb" + (state.ast.expr.value0 + ".")), render({
              ast: state.ast.expr.value1,
              lineIndex: state.lineIndex
          }) ]);
      };
      if (state.ast.expr instanceof Core.Apply) {
          var c = (function () {
              var $21 = isApplicable(state.ast.expr.value0);
              if ($21) {
                  return "applicable";
              };
              return "";
          })();
          return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.classes([ "apply", c ]), Halogen_HTML_Events.onClick(handleApplyClick(state.ast.id)(state.ast.expr.value0)) ])([ Halogen_HTML_Core.text("("), render({
              ast: state.ast.expr.value0,
              lineIndex: state.lineIndex
          }), Halogen_HTML_Core.text(" "), render({
              ast: state.ast.expr.value1,
              lineIndex: state.lineIndex
          }), Halogen_HTML_Core.text(")") ]);
      };
      throw new Error("Failed pattern match at Component.Node (line 57, column 3 - line 81, column 10): " + [ state.ast.expr.constructor.name ]);
  };
  var renderNode = function (state) {
      var edit = (function () {
          var $24 = state.lineIndex === 0;
          if ($24) {
              return Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("edit") ])([ Halogen_HTML_Core.text("edit") ]);
          };
          return Halogen_HTML_Core.text("");
      })();
      return Halogen_HTML_Elements.div([  ])([ render(state), edit ]);
  };
  var handleAction = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Web_Event_Event.stopPropagation(Web_UIEvent_MouseEvent.toEvent(v.value1))))(function (v1) {
          return Halogen_Query_HalogenM.raise(new Applied(v.value0));
      });
  };
...
(function($PS) {
  ...
  var Text_Parsing_Parser_Token = $PS["Text.Parsing.Parser.Token"];                
  var node = function (e) {
      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(e)(function (v) {
  ...
  var alphaNotLambda = Text_Parsing_Parser_String.satisfy(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(function (c) {
  ...
  var apply$prime = function (e) {
      return node(lexer.parens(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(e)(function (v) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(e)(function (v1) {
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Core.Apply(v, v1));
          });
      })));
  };
  var lambda = function (e) {
      return node(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(lexer.lexeme(Text_Parsing_Parser_String.oneOf(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)([ "\u03bb", "\\" ])))(function (v) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(lexer.identifier)(function (v1) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(lexer.lexeme(Text_Parsing_Parser_String["char"](Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(".")))(function (v2) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(e)(function (v3) {
                      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Core.Lambda(v1, v3));
                  });
              });
          });
      }));
  };
  var $$var = node(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Core.Var.create)(lexer.identifier));
  var expr = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (p) {
      return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)($$var))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(lambda(p))))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(apply$prime(p)));
  });
  var parse = function (s) {
      return Text_Parsing_Parser.runParser(s)(Text_Parsing_Parser_Combinators.between(Data_Identity.monadIdentity)(lexer.whiteSpace)(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity))(expr));
  };
  exports["parse"] = parse;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.3
  "use strict";
  $PS["Component.Stepper"] = $PS["Component.Stepper"] || {};
  var exports = $PS["Component.Stepper"];
  var Component_Node = $PS["Component.Node"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  var Core = $PS["Core"];
  ...
  var initState = function (v) {
      return {
          ...
          lines: Data_Monoid.mempty(Data_Monoid.monoidArray)
      };
  };
  var handleMessage = function (v) {
      return Data_Maybe.Just.create(new Applied(v.value0));
  };
  var handleInitialize = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
      return v.defaultContent;
  }))(function (v) {
      var parsed = Parse.parse(v);
      if (parsed instanceof Data_Either.Left) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log(Data_Show.show(Text_Parsing_Parser.showParseError)(parsed.value0))))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          });
      };
      if (parsed instanceof Data_Either.Right) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Core.replaceIds(parsed.value0)))(function (v1) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $23.lines = Data_Array.cons(v1)(s.lines);
                  return $23;
              });
          });
      };
      throw new Error("Failed pattern match at Component.Stepper (line 117, column 5 - line 123, column 54): " + [ parsed.constructor.name ]);
  });
  var handleApplied = function (id) {
      var toE2 = function (v) {
          if (v.expr instanceof Core.Apply) {
              return Data_Maybe.Just.create(v.expr.value1);
          };
          return Data_Maybe.Nothing.value;
      };
      var toE1 = function (v) {
          if (v.expr instanceof Core.Apply) {
              return Data_Maybe.Just.create(v.expr.value0);
          };
          return Data_Maybe.Nothing.value;
      };
      var lastLine = function ($56) {
          return Data_Array.head((function (v) {
              return v.lines;
          })($56));
      };
      var findNode = Core.findNode(id);
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(lastLine))(function (v) {
          if (v instanceof Data_Maybe.Just) {
              var mNode = Core.findNode(id)(v.value0);
              var mE1 = Control_Bind.bind(Data_Maybe.bindMaybe)(mNode)(toE1);
              var mE2 = Control_Bind.bind(Data_Maybe.bindMaybe)(mNode)(toE2);
              var v1 = new Data_Tuple.Tuple(mE1, mE2);
              if (v1.value0 instanceof Data_Maybe.Just && v1.value1 instanceof Data_Maybe.Just) {
                  var v2 = Core.applyLambda(v1.value0.value0)(v1.value1.value0);
                  if (v2 instanceof Data_Either.Left) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  };
                  if (v2 instanceof Data_Either.Right) {
                      var v3 = Core.replaceNode(id)(v2.value0)(v.value0);
                      ...
                      if (v3 instanceof Data_Either.Right) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                              ...
                              $44.lines = Data_Array.cons(v3.value0)(s.lines);
                              return $44;
                          });
                      };
                      throw new Error("Failed pattern match at Component.Stepper (line 89, column 15 - line 93, column 68): " + [ v3.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Component.Stepper (line 85, column 11 - line 93, column 68): " + [ v2.constructor.name ]);
              };
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
          };
          if (v instanceof Data_Maybe.Nothing) {
          ...
          throw new Error("Failed pattern match at Component.Stepper (line 78, column 3 - line 97, column 16): " + [ v.constructor.name ]);
      });
  };
  var handleAction = function (action) {
      ...
      if (action instanceof Applied) {
          return handleApplied(action.value0);
      };
      throw new Error("Failed pattern match at Component.Stepper (line 69, column 23 - line 73, column 21): " + [ action.constructor.name ]);
  };
  var _nodeSlot = Data_Symbol.SProxy.value;
  var renderLine = function (index) {
      return function (ast) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("line") ])([ Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "nodeSlot";
          }))(Data_Ord.ordInt)(_nodeSlot)(index)(Component_Node.component)({
              ast: ast,
              lineIndex: index
          })(handleMessage) ]);
      };
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("stepper") ])(Data_Array.mapWithIndex(renderLine)(Data_Array.reverse(state.lines)));
  };
  var component = Halogen_Component.mkComponent({
      initialState: initState,
      render: render,
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var Component_Stepper = $PS["Component.Stepper"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Function = $PS["Data.Function"];
  var Data_Functor = $PS["Data.Functor"];
      ...
      var init = function (node) {
          ...
          if (v instanceof Data_Maybe.Just) {
              return function __do() {
                  ...
                  removeChildren(node)();
                  return Halogen_Aff_Util.runHalogenAff(Halogen_VDom_Driver.runUI(Component_Stepper.component)({
                      defaultContent: v1
                  })(v.value0))();
              };
          };
          throw new Error("Failed pattern match at Main (line 38, column 11 - line 44, column 84): " + [ v.constructor.name ]);
      };
  ...
  var getStepperNodes = Control_Bind.composeKleisliFlipped(Effect.bindEffect)(Web_DOM_NodeList.toArray)((function () {
      var $14 = Web_DOM_ParentNode.querySelectorAll(".stepper");
      return function ($15) {
  ...
  var main = function __do() {
      var v = getDocument();
      var v1 = getStepperNodes(v)();
      return initSteppers(v1)();
  };
  exports["main"] = main;
  exports["getDocument"] = getDocument;
  exports["getStepperNodes"] = getStepperNodes;
  exports["initSteppers"] = initSteppers;

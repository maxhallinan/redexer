...
(function($PS) {
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.textarea([  ]) ]);
  };
  ...
  var handleInitialize = (function () {
      var parsed = Parse.parse("((\\x.\\y.x a) b)");
      ...
      throw new Error("Failed pattern match at Stepper (line 50, column 5 - line 56, column 55): " + [ parsed.constructor.name ]);
  })();
  ...
  var main = (function () {
      ...
      var initStepper = function (element) {
          return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
              return Halogen_VDom_Driver.runUI(Stepper.component)(Data_Unit.unit)(element);
          }));
      };
      return function __do() {
